...
function allset(){
 ...
 msgs.innerHTML="<h1 style='font-size:35px;text-align:center;color:#ffffff;'>PS4 Exploited And GoldHEN Loaded. ✔</h1>";
...
function kernelExploit() {
 ...
 var trigger_spray = function () {
  ...
  msgs.innerHTML="<h1 style='font-size:35px;text-align:center;color:black;'>1. Insert USB.<br>2. Remove USB after the notification has gone.<br>3. Press X</h1>";
